...
const schedule = {
  Monday: [
    { time: "6:30 AM", title: "Strength Training", color: "bg-green-600" },
    { time: "7:00 PM", title: "Strength Training", color: "bg-green-700" },
  ],
  Wednesday: [
    { time: "6:30 AM", title: "Strength Training", color: "bg-green-600" },
    { time: "7:00 PM", title: "Strength Training", color: "bg-green-700" },
  ...
  Friday: [
    { time: "7:00 PM", title: "Strength Training", color: "bg-green-600" },
  ],
  Saturday: [
    { time: "8:00 AM", title: "Strength Training", color: "bg-green-700" },
  ],
};
